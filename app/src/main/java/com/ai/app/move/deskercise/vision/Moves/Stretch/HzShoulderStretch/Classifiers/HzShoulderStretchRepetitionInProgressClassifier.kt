...
class HzShoulderStretchRepetitionInProgressClassifier {
    ...
    companion object {
        ...
        suspend fun check(person: Person): Boolean {
            ...
            if (leftWristYRatio < 0.2 || leftWristYRatio > 0.6 || rightWristYRatio < 0.2 || rightWristYRatio > 0.6) {
                hzShoulderStretchModel.badFrames += 1
                hzShoulderStretchModel.repetitionIsGood = false
                return false
            }
            ...
            yield()
            delay(100)
            hzShoulderStretchModel.goodFrames += 1
            hzShoulderStretchModel.repetitionIsGood = true
            return true
        }
    }
}
