...
package com.ai.app.move.deskercise.ml
...
import com.ai.app.move.deskercise.data.TorsoAndBodyDistance
...
enum class ModelType {
    Lightning,
// The slower version used for more accurate results
//    Thunder
}
...
//                    val x_translated = bitmap.height.toFloat() - output[idx * 3 + 0] * inputHeight * heightRatio
//                    val y_translated = bitmap.width.toFloat() - output[idx * 3 + 1] * inputWidth * widthRatio
...
//                        points[index * 2 + 1]
//                    )
//                //temp: after rotation + mirror
                keyPoint.translated_coordinate =
//                    PointF(
//                        points[index * 2 + 1],
//                        points[index * 2],
//                    )
                    PointF(
                        points[index * 2],
                        bitmap.height.toFloat() - points[index * 2 + 1],
                    )
            }
            // new crop region
