...
enum class BodyPart(val position: Int) {
    ...
    // CUSTOM BODY PART THAT DOES NOT COME TOGETHER WITH MOVENET.
    // THIS IS TO MATCH WITH APPLE CV
    // WE USE THE MID POINT OF LEFT AND RIGHT SHOULDER TO GET THE NECK
    NECK(17),
    CUSTOM(18),
    ;
